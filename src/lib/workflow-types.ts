...
export type DecisionNodeData = {
  description: string;
  outputs: Array<"reply" | "escalate" | "investigate">;
};

export type IntentReunderstandingNodeData = {
  label: string;
  maxTurns: number;
};

export type SectionHeaderNodeData = {
  title: string;
  subtitle?: string;
  kind: "routing" | "flow";
};
...
export type IntentReunderstandingFlowNode = Node<IntentReunderstandingNodeData, "intentReunderstanding">;
export type SectionHeaderFlowNode = Node<SectionHeaderNodeData, "sectionHeader">;
...
export type WorkflowNode =
  ...
  | EntryFlowNode
  | DecisionFlowNode
  | IntentReunderstandingFlowNode
  | SectionHeaderFlowNode;
